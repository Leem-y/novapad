...
class ThemedAboutDialog(ThemedDialog):
    """Scrollable About dialog — fixed size so it fits any screen."""
    ...
    def __init__(self, parent, title: str, message: str):
        ...
        self._inner.addWidget(scroll, 1)
        self._inner.addSpacing(4)
...
def themed_about(parent, title: str, message: str):
    d = ThemedAboutDialog(parent, title, message)
    d.exec()
