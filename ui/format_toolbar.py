...
def _make_icons(dark: bool, size: int = 16) -> tuple:
    ...
    # Bold — a clean typographic B using two rounded strokes
    bold_svg = (
        f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"'
        f' stroke="{c}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'
        f'<path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/>'
        f'<path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/>'
        f'</svg>'
    )

    # Italic — a clean slanted stroke with serifs at top and bottom
    italic_svg = (
        f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"'
        f' stroke="{c}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'
    ...
    # Underline — U shape with a flat underline bar
    underline_svg = (
        f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"'
        f' stroke="{c}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'
